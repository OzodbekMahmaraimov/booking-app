            ...
            >
                <div className='flex justify-between items-center'>
                    ...
                    <div className='w-[60%] p-3'>
                        ...
                        <p className='text-[1.5rem] mt-5 text-orange-500 tracking-wider font-semibold'>{detailsOfficanvas.btn1} RWF</p>
                    </div>
                </div>
                <div className='flex justify-between items-center border-y-2 border-gray-400 py-4 mt-8'>
                    ...
                    <p className='text-[1.5rem] text-orange-500 tracking-wider font-semibold'>
                        {Number(detailsOfficanvas.btn1) * Number(detailsOfficanvas.shoppingCount)} RWF
                    </p>
                </div>
